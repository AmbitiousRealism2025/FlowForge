...
export default function EditGigScreen() {
  ...
  const { gigs, updateGig, deleteGig } = useGigStore();
  ...
  const {
    ...
    onSubmit: async (formValues) => {
      ...
      try {
        ...
        Alert.alert('Error', 'Failed to update gig. Please try again.');
      }
    },
  });
  ...
  useEffect(() => {
    ...
    setFieldValue('title', gig.title);
    setFieldValue('venueName', gig.venueName);
    setFieldValue('address', gig.address || '');
    setFieldValue('date', gig.date);
    setFieldValue('callTime', gig.callTime);
    setFieldValue('contact', gig.contact || '');
    setFieldValue('compensation', gig.compensation || '');
    setFieldValue('notes', gig.notes || '');
  }, [id, gigs, setFieldValue]);
